...
// Static file - used as a style guide
...
pre {
	...
	line-height: 160%;
			...
			<section>
				...
				<p>
					<a class="mo-button" href="#">button</a>
					<a class="mo-button--alt" href="#">alt button</a>
					<a class="mo-button mo-button--big" href="#">big button</a>
					<a class="mo-button--alt mo-button--big" href="#">alt big button</a>
				</p>
				</form>
			</section>
		</main><!-- #main -->
