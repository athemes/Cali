<?php
/**
 * Template Name: Blog Single 2 Page
 *
...
get_header(); ?>
		...
		<main id="main" class="site-main">
			<section>
				<div class="single-post-layout">
					<article class="single-post post post-title--top post-title--align-left">
	...
	<aside id="secondary" class="widget-area col-md-4">
		<?php get_template_part( 'template-parts/content', 'sidebar_2-static' ); ?>
	</aside>
<?php
get_footer('static');
