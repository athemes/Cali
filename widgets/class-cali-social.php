 ...
 */
 ...
 class Cali_Social extends WP_Widget {

	function __construct() {
		$widget_ops = array( 'description' => __('Display your social icons', 'cali') );
		parent::__construct( 'cali-social-widget', __('Cali: Social Icons', 'cali'), $widget_ops );
	}
